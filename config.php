...
$KaceBoxDNS="For example, help.mycollege.edu";

#mysqli password on Dell Kace Box (from Settings -> General Settings)
...
#$mainQueueID=12; # leave set to 0 if you want your default queue to be your mainQueue.

$mainQueueName="Name of Main Queue";
